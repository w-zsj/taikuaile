<template> 
  <div>
    <el-upload :action="useOss?ossUploadUrl:minioUploadUrl" :data="useOss?dataObj:null" accept="image/jpeg,image/png"
      ...
      <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过{{maxSize}}MB</div>
    </el-upload>
...
export default {
  ...
  data() {
    return {
      ...
      ossUploadUrl: 'http://file-yinjiu.oss-cn-shanghai.aliyuncs.com',
